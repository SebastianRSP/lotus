    ...
    return (
        <div className="flex justify-center items-center text-white h-inherit">
            <div className="flex flex-col justify-between items-center text-center 2xl:gap-9 xl:gap-5 lg:gap-3 gap-7">
                ...
                <h4 className="2xl:text-5xl lg:text-2.5 md:text-4xl text-3xl 2xl:leading-54 lg:leading-46 md:leading-42 leading-9 font-extralight">
                    To redefine the <br />
                    internet of storage
                </h4>
                <blockquote className="xl:text-xl md:text-lg text-xs font-extralight 2xl:w-5/12 xl:w-6/12 lg:w-6/12 md:w-8/12 sm:w-8/12 w-full sm:px-0 px-4">
