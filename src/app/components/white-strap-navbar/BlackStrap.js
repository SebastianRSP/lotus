export const BlackStrap = () => {
    ...
    return (
        <div className={`md:bg-white bg-black backface-visibility-hidden h-4 absolute grid grid-cols-12 md:flex justify-center w-full z-0`}>
            ...
            <div className={`bg-black backface-visibility-hidden order-1 md:order-2 col-span-4 md:col-span-full 2xl:h-18 lg:h-14 h-16 z-10 lg:w-28.5p md:w-1/5 w-full relative`}>
