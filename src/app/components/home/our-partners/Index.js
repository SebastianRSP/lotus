...
export const OurPartners = () => {
  ...
  useEffect(() => {
    ...
    gsap.to(partnersContainer, {
      xPercent: -100, // Move 100% of the container width to the left
      ease: 'none',
      scrollTrigger: {
        trigger: partnerSection.current,
        start: 'top top',
        end: '+=1300', // Adjust the end value to control scroll length
        scrub: true,
      ...
      <div className="lg:grid grid-cols-12 justify-center items-center">
        ...
        <div className="xl:col-span-10 lg:col-span-9 overflow-hidden">
          <div
            ...
            style={{ minWidth: '150%' }} // Ensure it overflows horizontally
          >
